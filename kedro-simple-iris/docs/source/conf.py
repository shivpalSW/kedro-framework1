...
# kedro_simple_iris documentation build
...
from kedro_simple_iris import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_simple_iris"
author = "Kedro"
...
htmlhelp_basename = "kedro_simple_irisdoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_simple_iris.tex",
        "kedro_simple_iris Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_simple_iris",
        "Project kedro_simple_iris codebase.",
        "Data-Science",
    )
]
